...
# from original import models_ae
...
def get_args_parser():
    ...
    parser.add_argument('--kl_weight', type=float, default=0.001, metavar='N.')
...
def main(args):
    ...
    dataset_train, dataset_val = build_shape_surface_occupancy_dataset(args=args, if_transform=True, surface_sp_mode=cfg['dataset_opt']['surface_sp_mode'])
