...
from util.datasets import conditional_build_shape_surface_occupancy_dataset
from util.misc import NativeScalerWithGradNormCount as NativeScaler
from omegaconf import OmegaConf
import craftsman
# import diy_models_class_cond as models_class_cond
# import diy_models_ae as models_ae
...
def get_args_parser():
    ...
    parser.add_argument('--save_freq', default=20, type=int, help='How many epochs to save model')
...
def main(args):
    ...
    dataset_train, dataset_val = conditional_build_shape_surface_occupancy_dataset(args=args, **cfg['dataset_opt'])
...
if __name__ == '__main__':
    ...
    if args.output_dir:
        ...
        shutil.copy(args.config_path, os.path.join(args.output_dir, config_file_name))
